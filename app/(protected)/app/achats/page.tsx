  ...
  return (
    ...
    >
      ...
      <SidebarInset className="bg-background">
        <DashboardHeader title="Achats" />
        <div className="flex flex-1 flex-col gap-6 p-4 lg:p-8">
          {pharmacyId ? <PurchasesModule /> : <MissingPharmacyCard />}
        </div>
      </SidebarInset>
    </SidebarProvider>
  )
  ...
  return (
    <Card className="text-center">
      <CardHeader className="gap-2">
        ...
        <CardDescription>
          Demandez à l’administrateur de vous inviter dans l’organisation Clerk afin d’accéder au module Achats.
        </CardDescription>
      </CardHeader>
    </Card>
  )
