...
const purchaseOrders: PurchaseOrder[] = [
  ...
  },
  {
    ...
    status: "Livré",
    items: [
      { id: "line-3", product: "Vitamine C 1000", quantity: 12, unitPrice: 12.8 },
    ],
  },
  {
    id: "BC-2403",
  ...
  },
  {
    ...
    status: "Commandé",
    items: [
      { id: "line-6", product: "Paracétamol 1g", quantity: 30, unitPrice: 24.5 },
    ],
  },
  {
    id: "BC-2405",
    ...
    status: "Livré",
    items: [
      { id: "line-7", product: "Gants nitrile - Boite 100", quantity: 20, unitPrice: 86 },
    ],
  },
]
...
const deliveryNotes: DeliveryNote[] = [
  {
    ...
    status: "En cours",
    items: [
      { id: "line-8", product: "Paracétamol 1g", quantity: 10, unitPrice: 24.5 },
    ],
  },
  {
    id: "BL-1125",
    ...
    status: "Livré",
    items: [
      { id: "line-9", product: "Gants nitrile - Boite 100", quantity: 12, unitPrice: 86 },
    ],
  },
  {
    id: "BL-1126",
    ...
    status: "Brouillon",
    items: [
      { id: "line-10", product: "Ibuprofène 400mg", quantity: 8, unitPrice: 18.2 },
    ],
  },
  {
    id: "BL-1127",
    ...
    status: "En cours",
    items: [
      { id: "line-11", product: "Vitamine C 1000", quantity: 25, unitPrice: 12.8 },
    ],
  },
  {
    id: "BL-1128",
    ...
    status: "Livré",
    items: [
      { id: "line-12", product: "Paracétamol 1g", quantity: 15, unitPrice: 24.5 },
    ],
  },
]
